...
public class ProfileBb {
    ...
    public ProfileBb(String name, String email,
                     String license_number, String phone1, String phone2,
                     String phone3, String phone4, String phone5,
                     String address, String state, String district,
                     String pincode, String password, Timestamp registration_date,
                     Timestamp last_donation_date, int donorStatus) {
        this.name = name;
        this.email = email;
