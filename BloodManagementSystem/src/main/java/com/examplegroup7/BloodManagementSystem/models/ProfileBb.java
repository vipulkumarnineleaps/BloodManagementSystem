...
public class ProfileBb {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "profileBb_seq")
    @GenericGenerator(name = "profileBb_seq", strategy = "com.examplegroup7.BloodManagementSystem.utils.StringSequenceIdentifier", parameters = {
